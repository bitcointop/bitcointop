...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcointop/bitcointop>";
    const std::string URL_WEBSITE = "<https://bitcointop.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Bitcointop version %s\n", FormatFullVersion());
}
