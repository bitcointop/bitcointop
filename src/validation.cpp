...
const std::string strMessageMagic = "Bitcoin Top Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    if (nHeight < consensusParams.BCDHeight){
        ...
        nSubsidy >>= halvings;
        return nSubsidy;
    } else if (nHeight == consensusParams.BCDHeight){
        return 150 * 10000 * COIN * COIN_SCALE;
    } else if (nHeight <= 501880){
        return 12.5 * COIN * COIN_SCALE;
    } else if (nHeight <= 630000){
        return 8.06374 * COIN * COIN_SCALE;
    } else if (nHeight <= 840000){
        return 8.06374 * COIN * COIN_SCALE / 2;
    } else if (nHeight <= 1050000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2;
    } else if (nHeight <= 1260000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2;
    } else if (nHeight <= 1470000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 1680000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 1890000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 2100000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 2310000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 2520000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 2730000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 2940000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 3150000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 3360000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 3570000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 3780000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 3990000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 4200000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 4410000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 4620000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else if (nHeight <= 483000){
        return 8.06374 * COIN * COIN_SCALE / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2 / 2;
    } else{
        return 0;
    }
}
